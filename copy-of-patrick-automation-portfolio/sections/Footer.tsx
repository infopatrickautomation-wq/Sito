...
const Footer = () => {
  return (
    <footer className="bg-black border-t border-white/5 py-20 text-white/50">
      <div className="max-w-7xl mx-auto px-4 grid md:grid-cols-3 gap-16">
        <div>
          <img 
            ...
            style={{ height: '80px' }}
            className="w-auto mb-6 brightness-125 opacity-90 transition-all hover:scale-105 filter drop-shadow-[0_0_15px_rgba(37,99,235,0.4)]" 
          />
          <p className="leading-relaxed">Trasformiamo il modo in cui le aziende lavorano attraverso l'Intelligenza Artificiale.</p>
        </div>
        <div>
          <h4 className="text-white font-bold mb-6">Contatti</h4>
          <div className="space-y-4">
            <div className="flex gap-4 items-center hover:text-white transition-colors cursor-pointer">
      ...
      <div className="max-w-7xl mx-auto px-4 mt-20 pt-10 border-t border-white/5 text-center text-sm">
