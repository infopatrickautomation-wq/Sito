      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div ref={contentRef} className={`transition-all duration-700 ${contentVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            ...
            <h2 className="text-4xl md:text-5xl font-bold text-white mb-6 font-montserrat uppercase tracking-tight">
          ...
          <div className="space-y-8">
            <div className="grid grid-cols-1 gap-6">
              {benefits.map((b, i) => (
                <div key={i} className="p-8 rounded-3xl bg-white/5 border border-white/5 hover:border-blue-600/30 transition-all">
                  <div className="flex gap-6 items-start">
                    <div className="p-4 rounded-2xl bg-blue-600/10 text-[#FFBF00]">
