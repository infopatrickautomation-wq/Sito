          ...
          {services.map((service, index) => {
            ...
            return (
              <div
                key={index}
                ref={cardRef}
                className={`group relative bg-white/[0.03] rounded-[3rem] overflow-hidden border border-white/5 transition-all duration-300 ease-in-out p-12 hover:border-blue-600 hover:shadow-[0_0_25px_rgba(37,99,235,0.3)] ${
